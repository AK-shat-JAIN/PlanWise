        ...
        <HomeLayout>
            <div className="flex items-center justify-center min-h-[90vh]">
                ...
                >
                    ...
                    <h1 className="mx-6 text-center text-2xl sm:text-4xl font-semibold">Upload Your Academic Record</h1>
                        ...
                        <div className="self-center">
                                ...
                                <label htmlFor="image_upload" className="cursor-pointer">
                                    {userInput.previewImage ? (
                                        ...
                                        <div className="w-full h-44 m-auto flex items-center justify-center border">
                                            <h1 className="font-bold text-lg text-center">Upload your Syllabus</h1>
                                        </div>
                                    )}
                                </label>
                                <input
                            ...
                            <div className="flex flex-col gap-1 mt-5">
                                ...
                                <input 
                                    ...
                                    name="title"
                                    id="title"
                                    placeholder="Enter your Planner Title"
                                    type="text"
                        ...
                        <div className="flex flex-col gap-1">
                            <div className="flex flex-col gap-1">
                                <label htmlFor="createdBy" className="text-lg font-semibold">
                                    Enter Your Study Hours per Day
                                </label>
                                <input 
                                    required
                                    className="bg-transparent px-2 py-1 border-b-2 border-white focus:outline-none focus:border-yellow-500"
                                    name="createdBy"
                                    id="createdBy"
                                    placeholder="Enter your Study Hours per Day"
                                    type="text"
                                    onChange={handleUserInput}
                            ...
                            <div className="flex flex-col gap-1 mt-2">
                                ...
                                <input 
                                    ...
                                    name="category"
                                    id="category"
                                    placeholder="Enter your Deadline in Days"
                                    type="text"
                                    onChange={handleUserInput}
                            ...
                            <div className="flex flex-col gap-1 mt-2">
                                ...
                                <textarea 
                                    ...
                                    name="description"
                                    id="description"
                                    placeholder="Eg. Weak point, Strong Areas, Academic Record, etc."
                                    onChange={handleUserInput}
                ...
                <iframe
                    src="https://customized-planner.streamlit.app/?embed=true"
                    height="450"
